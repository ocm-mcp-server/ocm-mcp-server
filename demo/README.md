...
| `connect-claude.mp4` | The same recording as MP4 with a narrated voice track (macOS `say`, segments aligned to the chapter markers), linked from the README caption; GitHub's blob page plays it with sound. |
