...
**Published results** ([`eval/results/published/`](eval/results/README.md)), failures
...
| [Blog posts](blogs/README.md) | long-form deep dives: the guardrail design, ten lessons for MCP servers, the three-agent evaluation, and the fleet-scale benchmarks |
