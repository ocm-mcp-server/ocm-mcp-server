...
**Verdict: 🟢 ALL GREEN** &nbsp;·&nbsp; generated 2026-07-28 09:57:58 &nbsp;·&nbsp; local kind fleet via podman, Open Cluster Management hub
...
cluster1   true           https://cluster1-control-plane:6443   True     True        4m
cluster2   true           https://cluster2-control-plane:6443   True     True        3m36s
```
...
```
```
proposal_id=56568c0802724d9faa987f681c562501
{
  "status": "applied",
  "cluster": "cluster1",
...
[
  {
    ...
    "type": "Normal",
    "reason": "Pulled",
    "object": "Pod/payments-5555cb47bc-dn76m",
    "count": 1,
    "message": "Successfully pulled image \"registry.k8s.io/e2e-test-images/agnhost:2.47\" in 1.539s (11.721s including waiting). Image size: 50637101 bytes."
  },
  {
    "namespace": "shop",
    "type": "Normal",
  ...
  },
  {
    ...
    "type": "Normal",
    "reason": "Started",
    "object": "Pod/payments-5555cb47bc-wq9kg",
    "count": 1,
    "message": "Started container payments"
  },
  {
    ...
    "object": "Pod/payments-5555cb47bc-wq9kg",
    "count": 1,
    "message": "Successfully pulled image \"registry.k8s.io/e2e-test-images/agnhost:2.47\" in 10.184s (10.184s including waiting). Image size: 50637101 bytes."
... (13 more lines)
```
...
```
{
  ...
  "kind": "ManagedCluster",
  "metadata": {
    "creationTimestamp": "2026-07-28T04:22:35Z",
    "finalizers": [
...
{
  "namespace": "shop",
  "pod": "payments-5555cb47bc-dn76m",
  "log_tail": "b'I0728 04:26:47.541306       1 log.go:245] Started HTTP server on port 8080\\nI0728 04:26:47.541434       1 log.go:245] Started UDP server on port  8081\\nI0728 04:26:49.637957       1 log.go:245] GET /healthz\\nI0728 04:26:55.714584       1 log.go:245] GET /healthz\\n'"
}
```
...
```
```
proposal_id=518d6215329144be8d7fba9702d14276
...
```
$ ocm-mcp approve 518d6215329144be8d7fba9702d14276
```
```
token minted (...-4EFsDNMJ8Aw)
```
...
```
{
  "rollback_proposal_id": "c14aa41ee1374912939b7ffca55de18b",
  "status": "pending_approval",
  "next_step": "Ask the human operator to run: ocm-mcp approve c14aa41ee1374912939b7ffca55de18b and give you the token, then call rollback_manifestwork(c14aa41ee1374912939b7ffca55de18b, <token>)."
}
```
...
```
{
  "proposal_id": "8d5b18ff2585472395356080a8e67862",
  "status": "pending_approval",
  "action": "cordon",
  "next_step": "Ask the human operator to run: ocm-mcp approve 8d5b18ff2585472395356080a8e67862 and provide you the approval token, then call apply_cluster_action."
}
```
...
```
```
taints=[{"effect": "NoSelect", "key": "ocm-mcp-server.io/cordoned", "timeAdded": "2026-07-28T04:27:05Z", "value": "true"}]
```
...
```
[
{"tool": "apply_cluster_action", "args": {"proposal_id": "e4266eeb96d1469089794a5c731c49f7", "approval_token": "<redacted>"}, "outcome": "ok", "error": "", "duration_ms": 7, "ts": 1785212825.566769, "actor": "sandeepbazar:35621", "seq": 15, "prev": "9a4148d79fdb2c3c3cef4317144452e6f7072307eb6cf6e4174cda9cd60e770a", "hash": "e49d6908afe2076daf0a8eea3bc7f6dd0fdce8a117532c54dae210b19a9ae68b"},
{"tool": "propose_cluster_action", "args": {"cluster": "cluster1", "action": "accept", "summary": "accept (gated, idempotent)", "params_json": "{}"}, "outcome": "ok", "error": "", "duration_ms": 7, "ts": 1785212825.576585, "actor": "sandeepbazar:35621", "seq": 16, "prev": "e49d6908afe2076daf0a8eea3bc7f6dd0fdce8a117532c54dae210b19a9ae68b", "hash": "7efe35e49168ce25c38bb3913c2612a0359c113db2221f2836c83f8a60971b22"},
{"tool": "apply_cluster_action", "args": {"proposal_id": "25d762ebd5b64594a1a67f061e31ef4c", "approval_token": "<redacted>"}, "outcome": "ok", "error": "", "duration_ms": 8, "ts": 1785212825.585314, "actor": "sandeepbazar:35621", "seq": 17, "prev": "7efe35e49168ce25c38bb3913c2612a0359c113db2221f2836c83f8a60971b22", "hash": "82b448641dbe94cf808e98f9e4f4da9a484b79efcf9d2d533d126814207b9f62"},
...
```
```
REJECTED: proposal 7105aed1db35407ea4b79486ae8be021 is 'applied', not pending.
```
...
```
{
  "unhealthy_pods": [
    {
      "namespace": "shop",
      "name": "payments-v2-6f6596d897-mlcb9",
      "phase": "Pending",
      "waiting": [
        "ErrImagePull"
      ],
    ...
    {
      "namespace": "shop",
      "name": "payments-v2-6f6596d897-rg978",
      "phase": "Pending",
      "waiting": [
        "ErrImagePull"
      ],
...
[
  {
    ...
    "type": "Normal",
    "reason": "BackOff",
    "object": "Pod/payments-v2-6f6596d897-rg978",
    "count": 1,
  ...
  },
  {
    ...
    "type": "Warning",
    "reason": "Failed",
    "object": "Pod/payments-v2-6f6596d897-mlcb9",
    "count": 1,
...
```
```
proposal_id=cf2c34fe715349aa926aca31e534c35f
