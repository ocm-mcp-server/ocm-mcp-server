...
**Verdict: 🟢 ALL GREEN** &nbsp;·&nbsp; generated 2026-08-30 00:17:01 &nbsp;·&nbsp; local kind fleet via podman, Open Cluster Management hub
...
cluster1   true           https://cluster1-control-plane:6443   True     True        98s
cluster2   true           https://cluster2-control-plane:6443   True     True        74s
```
...
```
```
proposal_id=a813d57aac3945c38788290166ed976c
{
  "status": "applied",
  "cluster": "cluster1",
...
[
  {
    ...
    "type": "Normal",
    "reason": "Pulled",
    "object": "Pod/payments-5555cb47bc-mmrnp",
    "count": 1,
    "message": "Successfully pulled image \"registry.k8s.io/e2e-test-images/agnhost:2.47\" in 194ms (17.066s including waiting). Image size: 50637101 bytes."
  },
  {
    "namespace": "shop",
    "type": "Normal",
  ...
  },
  {
    ...
    "type": "Normal",
    "reason": "Pulled",
    "object": "Pod/payments-5555cb47bc-qnkvs",
    "count": 1,
    "message": "Successfully pulled image \"registry.k8s.io/e2e-test-images/agnhost:2.47\" in 16.873s (16.873s including waiting). Image size: 50637101 bytes."
  },
  {
    "namespace": "shop",
    "type": "Normal",
...
```
{
  ...
  "kind": "ManagedCluster",
  "metadata": {
    "creationTimestamp": "2026-08-29T18:43:59Z",
    "finalizers": [
...
{
  "namespace": "shop",
  "pod": "payments-5555cb47bc-mmrnp",
  "log_tail": "b'I0829 18:45:55.084434       1 log.go:245] Started HTTP server on port 8080\\nI0829 18:45:55.084512       1 log.go:245] Started UDP server on port  8081\\n'"
}
```
...
```
```
proposal_id=152019fa7e554bfe9561f93eda385938
...
```
$ ocm-mcp approve 152019fa7e554bfe9561f93eda385938
```
```
token minted (...oY4o1wLOeaDw)
```
...
```
{
  "rollback_proposal_id": "98cadb7f7ebf41e7829c1c24e4570ae2",
  "status": "pending_approval",
  "next_step": "Ask the human operator to run: ocm-mcp approve 98cadb7f7ebf41e7829c1c24e4570ae2 and give you the token, then call rollback_manifestwork(98cadb7f7ebf41e7829c1c24e4570ae2, <token>)."
}
```
...
```
{
  "proposal_id": "6060f330ebbb400cb423a3c8f768d343",
  "status": "pending_approval",
  "action": "cordon",
  "next_step": "Ask the human operator to run: ocm-mcp approve 6060f330ebbb400cb423a3c8f768d343 and provide you the approval token, then call apply_cluster_action."
}
```
...
```
```
taints=[{"effect": "NoSelect", "key": "ocm-mcp-server.io/cordoned", "timeAdded": "2026-08-29T18:46:05Z", "value": "true"}]
```
...
```
[
{"tool": "apply_cluster_action", "args": {"proposal_id": "4f5b6f37466f4cd9a18189e75d7cdbae", "approval_token": "<redacted>"}, "outcome": "ok", "error": "", "duration_ms": 6, "ts": 1788029166.042579, "actor": "sandeepbazar:36854", "seq": 15, "prev": "6ea0dc4344f20ad21576e0f475bf87ea5ea0c3e4f90319610f0e5f4243fc5852", "hash": "2d26678de765b50e90cab4a7e31e61cbedd6c6adb6b1f89b3d8502c3ba200a12"},
{"tool": "propose_cluster_action", "args": {"cluster": "cluster1", "action": "accept", "summary": "accept (gated, idempotent)", "params_json": "{}"}, "outcome": "ok", "error": "", "duration_ms": 7, "ts": 1788029166.052022, "actor": "sandeepbazar:36854", "seq": 16, "prev": "2d26678de765b50e90cab4a7e31e61cbedd6c6adb6b1f89b3d8502c3ba200a12", "hash": "b6d4ab47084051b2abb161b7f6d751b7c10368f13ef97783466f5ba4d29b7bf5"},
{"tool": "apply_cluster_action", "args": {"proposal_id": "da77e9bf715e4f7ea88fb9edfa2e4d9e", "approval_token": "<redacted>"}, "outcome": "ok", "error": "", "duration_ms": 10, "ts": 1788029166.0630322, "actor": "sandeepbazar:36854", "seq": 17, "prev": "b6d4ab47084051b2abb161b7f6d751b7c10368f13ef97783466f5ba4d29b7bf5", "hash": "3389d5d15fda0b6fda35ff04717cbbcd2e4d26c8dabba8387c118fb5ac23cdf7"},
...
```
```
REJECTED: proposal 44d4ebab4ac0433084c2d67bdf35bcef is 'applied', not pending.
```
...
```
{
  "unhealthy_pods": [
    {
      "namespace": "shop",
      "name": "payments-v2-6f6596d897-55p92",
      "phase": "Pending",
      "waiting": [
        "ImagePullBackOff"
      ],
    ...
    {
      "namespace": "shop",
      "name": "payments-v2-6f6596d897-7xhbq",
      "phase": "Pending",
      "waiting": [
        "ErrImagePull"
      ],
...
[
  {
    ...
    "type": "Warning",
    "reason": "Failed",
    "object": "Pod/payments-v2-6f6596d897-55p92",
    "count": 2,
  ...
  },
  {
    ...
    "type": "Normal",
    "reason": "BackOff",
    "object": "Pod/payments-v2-6f6596d897-7xhbq",
    "count": 1,
    "message": "Back-off pulling image \"registry.k8s.io/e2e-test-images/agnhost:2.47-nonexistent\""
... (2 more lines)
```
...
```
```
proposal_id=a7e3abac1aaa444dad357b5beab7c830
