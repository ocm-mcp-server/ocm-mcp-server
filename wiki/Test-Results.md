...
**Verdict: 🟢 ALL GREEN** &nbsp;·&nbsp; generated 2026-07-25 23:15:00 &nbsp;·&nbsp; local kind fleet via podman, Open Cluster Management hub
...
cluster1   true           https://cluster1-control-plane:6443   True     True        99s
...
_Deploy a marker ManifestWork so the work tools report on something real._
...
[
  {
    ...
    "type": "Normal",
    "reason": "Pulled",
    "object": "Pod/payments-df965d5f-5kmxs",
    "count": 1,
    "message": "Successfully pulled image \"registry.k8s.io/e2e-test-images/agnhost:2.47\" in 192ms (16.488s including waiting). Image size: 50637101 bytes."
  },
  {
    "namespace": "shop",
    "type": "Normal",
  ...
  },
  {
    ...
    "type": "Normal",
    "reason": "Pulled",
    "object": "Pod/payments-df965d5f-blqkq",
    "count": 1,
    "message": "Successfully pulled image \"registry.k8s.io/e2e-test-images/agnhost:2.47\" in 16.306s (16.306s including waiting). Image size: 50637101 bytes."
  },
  {
    "namespace": "shop",
    "type": "Normal",
...
```
{
  ...
  "kind": "ManagedCluster",
  "metadata": {
    "creationTimestamp": "2026-07-25T17:42:12Z",
    "finalizers": [
...
```
```
proposal_id=41a126005a9841f6aaa59d2e5ab7dbf2
...
```
$ ocm-mcp approve 41a126005a9841f6aaa59d2e5ab7dbf2
```
```
token minted (...O8RMpz7hOnCQ)
```
...
```
{
  "proposal_id": "aa3f23cb05384771b88093e301cf2430",
  "status": "pending_approval",
  "action": "cordon",
  "next_step": "Ask the human operator to run: ocm-mcp approve aa3f23cb05384771b88093e301cf2430 and provide you the approval token, then call apply_cluster_action."
}
```
...
```
```
taints=[{"effect": "NoSelect", "key": "ocm-mcp-server.io/cordoned", "timeAdded": "2026-07-25T17:44:25Z", "value": "true"}]
```
...
```
[
{"tool": "apply_manifestwork", "args": {"proposal_id": "41a126005a9841f6aaa59d2e5ab7dbf2", "approval_token": "<redacted>"}, "outcome": "rejected", "error": "", "duration_ms": 0, "ts": 1785001460.768882},
{"tool": "apply_manifestwork", "args": {"proposal_id": "41a126005a9841f6aaa59d2e5ab7dbf2", "approval_token": "<redacted>"}, "outcome": "ok", "error": "", "duration_ms": 7, "ts": 1785001460.779019},
{"tool": "get_manifestwork", "args": {"cluster": "cluster1", "name": "e2e-demo"}, "outcome": "ok", "error": "", "duration_ms": 2, "ts": 1785001465.781867},
{"tool": "propose_cluster_action", "args": {"cluster": "cluster1", "action": "cordon", "summary": "Cordon for maintenance.", "params_json": "{}"}, "outcome": "ok", "error": "", "duration_ms": 7, "ts": 1785001465.789597},
{"tool": "apply_cluster_action", "args": {"proposal_id": "aa3f23cb05384771b88093e301cf2430", "approval_token": "<redacted>"}, "outcome": "ok", "error": "", "duration_ms": 8, "ts": 1785001465.797923},
{"tool": "propose_cluster_action", "args": {"cluster": "cluster1", "action": "uncordon", "summary": "Undo.", "params_json": "{}"}, "outcome": "ok", "error": "", "duration_ms": 8, "ts": 1785001465.808213},
{"tool": "apply_cluster_action", "args": {"proposal_id": "5f0f1ee65c30485dab368f46b67a9139", "approval_token": "<redacted>"}, "outcome": "ok", "error": "", "duration_ms": 10, "ts": 1785001465.818471},
{"tool": "lis
... (truncated)
```
...
```
{
  "unhealthy_pods": [
    {
      "namespace": "shop",
      "name": "payments-v2-68bf75f6cc-hz8c4",
      "phase": "Pending",
      "waiting": [
        "ErrImagePull"
      ],
    ...
    {
      "namespace": "shop",
      "name": "payments-v2-68bf75f6cc-wlwl7",
      "phase": "Pending",
      "waiting": [
        "ErrImagePull"
      ],
...
[
  {
    ...
    "type": "Warning",
    "reason": "Failed",
    "object": "Pod/payments-v2-68bf75f6cc-hz8c4",
    "count": 1,
  ...
  },
  {
    ...
    "type": "Warning",
    "reason": "Failed",
    "object": "Pod/payments-v2-68bf75f6cc-wlwl7",
    "count": 1,
...
```
```
proposal_id=d52771462782497f9248b3f7ec5d4a77
