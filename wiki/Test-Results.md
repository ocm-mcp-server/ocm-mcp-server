...
**Verdict: 🟢 ALL GREEN** &nbsp;·&nbsp; generated 2026-08-29 22:58:10 &nbsp;·&nbsp; local kind fleet via podman, Open Cluster Management hub
...
cluster2   true           https://cluster2-control-plane:6443   True     True        71s
```
...
```
```
proposal_id=8fe7f735d2d24f1ead2be880c714a20f
{
  "status": "applied",
  "cluster": "cluster1",
...
[
  {
    ...
    "type": "Normal",
    "reason": "Pulled",
    "object": "Pod/payments-5555cb47bc-xhtcp",
    "count": 1,
    "message": "Successfully pulled image \"registry.k8s.io/e2e-test-images/agnhost:2.47\" in 208ms (11.175s including waiting). Image size: 50637101 bytes."
  },
  {
    "namespace": "shop",
    "type": "Normal",
  ...
  },
  {
    ...
    "type": "Normal",
    "reason": "Pulled",
    "object": "Pod/payments-5555cb47bc-xnmjl",
    "count": 1,
    "message": "Successfully pulled image \"registry.k8s.io/e2e-test-images/agnhost:2.47\" in 10.974s (10.974s including waiting). Image size: 50637101 bytes."
  },
  {
    "namespace": "shop",
    "type": "Normal",
...
```
{
  ...
  "kind": "ManagedCluster",
  "metadata": {
    "creationTimestamp": "2026-08-29T17:25:09Z",
    "finalizers": [
...
{
  "namespace": "shop",
  "pod": "payments-5555cb47bc-xhtcp",
  "log_tail": "b'I0829 17:26:58.409211       1 log.go:245] Started HTTP server on port 8080\\nI0829 17:26:58.409300       1 log.go:245] Started UDP server on port  8081\\nI0829 17:27:00.290023       1 log.go:245] GET /healthz\\n'"
}
```
...
```
```
proposal_id=359dabb232e94cc68e7291d99cc10483
...
```
$ ocm-mcp approve 359dabb232e94cc68e7291d99cc10483
```
```
token minted (...HZxpHxRltQDQ)
```
...
```
{
  "rollback_proposal_id": "e2ef0d05f9a3406eb8c1e6cff6253c1e",
  "status": "pending_approval",
  "next_step": "Ask the human operator to run: ocm-mcp approve e2ef0d05f9a3406eb8c1e6cff6253c1e and give you the token, then call rollback_manifestwork(e2ef0d05f9a3406eb8c1e6cff6253c1e, <token>)."
}
```
...
```
{
  "proposal_id": "c8c72f847a784a3ba66f50186b7ffb85",
  "status": "pending_approval",
  "action": "cordon",
  "next_step": "Ask the human operator to run: ocm-mcp approve c8c72f847a784a3ba66f50186b7ffb85 and provide you the approval token, then call apply_cluster_action."
}
```
...
```
```
taints=[{"effect": "NoSelect", "key": "ocm-mcp-server.io/cordoned", "timeAdded": "2026-08-29T17:27:15Z", "value": "true"}]
```
...
```
[
{"tool": "apply_cluster_action", "args": {"proposal_id": "3a678d2716d943f6aa46c1007f9dc3ed", "approval_token": "<redacted>"}, "outcome": "ok", "error": "", "duration_ms": 8, "ts": 1788024435.108356, "actor": "sandeepbazar:2646", "seq": 15, "prev": "1662d9acb0647323e68220bf9bfcaf0f45050ede71b5a493dade185901215b42", "hash": "a82b4995a0d5715d117e10c4b379fe9dd6049fe59a9a2b18841df186598a8f41"},
{"tool": "propose_cluster_action", "args": {"cluster": "cluster1", "action": "accept", "summary": "accept (gated, idempotent)", "params_json": "{}"}, "outcome": "ok", "error": "", "duration_ms": 8, "ts": 1788024435.118815, "actor": "sandeepbazar:2646", "seq": 16, "prev": "a82b4995a0d5715d117e10c4b379fe9dd6049fe59a9a2b18841df186598a8f41", "hash": "49aba6ff91e1f4ebecbfccdf309512cd7acc489a50d6ad6fcf1348baf404e7b2"},
{"tool": "apply_cluster_action", "args": {"proposal_id": "247ccc17ba144d748f47e6db37f14828", "approval_token": "<redacted>"}, "outcome": "ok", "error": "", "duration_ms": 9, "ts": 1788024435.12846, "actor": "sandeepbazar:2646", "seq": 17, "prev": "49aba6ff91e1f4ebecbfccdf309512cd7acc489a50d6ad6fcf1348baf404e7b2", "hash": "ff4b6e4628ebccdc1bfcd6d20516fbb02b6563c9bd8fa2db505873a786f75fb1"},
{"tool": "propose_cluster_action", "args": {"cluster": "cluster1", "action": "enable_addon", "summary": "enable_addon (gated)", "params_json": "{\"addon\": \"e2e-demo-addon\"}"}, "outcome": "ok", 
... (truncated)
```
...
```
```
REJECTED: proposal 5a520ec320f44e28a0d4b4cf6f6b6878 is 'applied', not pending.
```
...
```
{
  "unhealthy_pods": [
    {
      "namespace": "shop",
      "name": "payments-v2-6f6596d897-ss7kk",
      "phase": "Pending",
      "waiting": [
        "ImagePullBackOff"
      ],
    ...
    {
      "namespace": "shop",
      "name": "payments-v2-6f6596d897-vffx6",
      "phase": "Pending",
      "waiting": [
        "ImagePullBackOff"
      ],
...
[
  {
    ...
    "type": "Normal",
    "reason": "BackOff",
    "object": "Pod/payments-v2-6f6596d897-ss7kk",
    "count": 1,
  ...
  },
  {
    ...
    "type": "Normal",
    "reason": "BackOff",
    "object": "Pod/payments-v2-6f6596d897-vffx6",
    "count": 1,
    "message": "Back-off pulling image \"registry.k8s.io/e2e-test-images/agnhost:2.47-nonexistent\""
  },
  {
...
```
```
proposal_id=653b32c3dd11423cbc4c65438e6e0de7
